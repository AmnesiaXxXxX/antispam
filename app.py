...
- 📌 **Автоматическое обнаружение подозрительных сообщений**  
  Использует алгоритмы для фильтрации нежелательных сообщений.
- 📌 **Фильтрация по ключевым словам**  
  Удаляет сообщения, содержащие запрещенные слова.
- 📌 **Защита от специальных символов**  
  Распознает и блокирует сообщения с использованием запрещенных символов.
- 📌 **Проверка новых пользователей через FunStat API**  
  Автоматическая проверка участников при вступлении.

### 👮 Модерация
- 📌 **Автоматическое или ручное удаление спама**  
  Поддержка как полностью автоматического режима, так и ручной модерации.
- 📌 **Возможность бана нарушителей**  
  Инструменты для временного или постоянного бана.
- 📌 **Пересылка подозрительных сообщений в канал модерации**  
  Все потенциально опасные сообщения отправляются на проверку модератору.
- 📌 **Гибкая настройка автомодерации для каждого чата**  
  Возможность настроить фильтры под потребности каждого сообщества.

### ⚙️ Настройки
- 📌 **Управление через удобное меню с кнопками**  
  Удобный интерфейс для работы с ботом.
- 📌 **Настройка порога чувствительности фильтров**  
  Регулировка уровня агрессивности фильтрации.
- 📌 **Добавление/удаление запрещенных слов**  
  Возможность изменять список слов по чату.
- 📌 **Включение/отключение автомодерации**  
  Быстрое управление режимами работы.

### 📊 Статистика
- 📌 **Отслеживание количества сообщений**  
  Показывает статистику сообщений в чате.
- 📌 **Подсчет удаленных сообщений**  
  Учет всех удаленных ботом сообщений.
- 📌 **Статистика по пользователям**  
  Рейтинг пользователей по активности или нарушениям.
- 📌 **История банов**  
  Отчеты о блокировках участников.

### 🗄️ База данных
- 📌 **SQLite для хранения данных**  
  Эффективное хранение всех данных бота.
- 📌 **Отдельные таблицы для каналов, сообщений и статистики**  
  Упрощенная структура базы для быстрого доступа.
- 📌 **Сохранение настроек для каждого чата**  
  Поддержка уникальных конфигураций для разных чатов.
- 📌 **Список запрещенных слов по чатам**  
  Локальные фильтры для каждого чата.

### 📝 Логирование
- 📌 **Ротация логов**  
  Поддержка архивации старых логов.
- 📌 **Детальное логирование действий**  
  Отслеживание всех операций бота.
- 📌 **Отслеживание ошибок**  
  Логирование ошибок для упрощения их устранения.
- 📌 **Сохранение истории операций**  
  Полный список выполненных команд и действий.

### 🔒 Безопасность
- 📌 **Проверка прав администратора**  
  Удостоверение в наличии нужных привилегий.
- 📌 **Защита команд управления**  
  Команды доступны только администраторам.
- 📌 **Сохранение конфиденциальных данных в .env файле**  
  Защита важных данных от утечки.
- 📌 **Исключение ложных срабатываний**  
  Минимизация ошибок фильтрации.
...
- 📌 **Кэширование данных**  
  Ускорение работы за счет временного хранения данных.
- 📌 **Оптимизированные алгоритмы фильтрации**  
  Быстрое и точное определение спама.
"""
